            ...
            <div className={"Sidebar"}>
                <div className={"level-right mx-5 mb-5"}>
                    <svg
                        ...
                        <g className={"a"} transform={"translate(0 0.547)"}>
                            <g transform={"translate(17.891 3.22)"}>
                                <path
                                    ...
                                    transform={"translate(-272.64 -351.203)"}
                                />
                                <path
                                    className={"b"}
                                    d={
                                    ...
                                    transform={"translate(-299.472 -375.831)"}
                                />
                                <path
                                    className={"b"}
                                    d={
                                    ...
                                    transform={"translate(-370.063 -375.84)"}
                                />
                                <path
                                    className={"b"}
                                    d={
                                    ...
                                    transform={"translate(-434.52 -350)"}
                                />
                            </g>
                            <path
                                className={"b"}
                                ...
                                transform={"translate(-160.671 -41.297)"}
                            />
                            <circle
                                className={"c"}
                                cx={4.395}
